...
const LINES = {
  ...
  BIDDING_QUESTION: [
    ...
    `You got power or you got potential? There's a difference, motherfucka. Count the power first.`,
    ...
    `Forget the whole hand for a second. How many aces you sitting on, motherfucka?`,
  ],
  ...
  BIDDING_CONFIDENT: [
    ...
    `That hand got weight to it. Bid with your chest, motherfucka.`,
  ...
  BIDDING_CAUTIOUS: [
    ...
    `Some hands are workers, not winners. This might be one of those, motherfucka.`,
  ...
  ALL_BIDS_OVERBID: [
    ...
    `{totalBid} on 13. One of these motherfuckas is writing checks their hand can't cash.`,
  ],

  ALL_BIDS_STRONG: [
    `We came to play. {teamBid} between us. Let's get it, motherfucka.`,
  ...
  ALL_BIDS_LIGHT: [
    ...
    `We ain't trying to be heroes. Make the bid. Control the motherfuckin bags.`,
  ],
  ...
  PLAY_LEAD_STRONG: [
    ...
    `When you lead, lead like you MEAN it. Make them react to you, motherfucka.`,
  ...
  PLAY_FOLLOW_LOW: [
    ...
    `Play small. Not every trick is worth fighting for, motherfucka.`,
  ],

  PLAY_TRUMP_DECISION: [
    `You thinking about cutting? Make damn sure it's worth the spade.`,
    `Spades don't grow on trees, motherfucka. If you cutting, make it count.`,
  ...
  PLAY_PARTNER_WINNING: [
    ...
    `When your partner is winning, your job is to stay out of it. Throw trash, motherfucka.`,
  ],
  ...
  TRICK_WIN_TEAM: [
    ...
    `One more in the bank. Keep it moving, motherfucka.`,
    `Sheeeeit. They didn't even see that coming.`,
  ],

  TRICK_WIN_TEAM_BIG: [
    `You took that like you BEEN doing this your whole life. Damn.`,
    `That was a grown-up play right there. I see you, motherfucka.`,
    `That's the kind of trick that changes a damn game. Remember how that felt.`,
    `THAT is what I'm talking about. You read that whole damn table, motherfucka.`,
  ...
  TRICK_LOSS_COSTLY: [
    ...
    `...that was one of ours. Think about what just happened there, motherfucka.`,
  ...
  SPADES_BROKEN: [
    ...
    `Somebody broke spades. New rules now, motherfucka — anyone can lead trump.`,
  ...
  NIL_DANGER_HUMAN: [
    ...
    `This is the part where nil gets dangerous, motherfucka. Play the absolute bottom.`,
  ...
  NIL_DANGER_PARTNER: [
    ...
    `Your partner needs you right now, motherfucka. Play high and pull that trick away from them.`,
    `This is where partnerships show. Cover that nil.`,
  ],

  NIL_FAILED_HUMAN: [
    `That nil is done. Shit happens. Shake it off — we still got a game to play.`,
    `Nil caught your ass. It's 100 points but it ain't the whole game. Refocus.`,
    `That one didn't go. But I've seen motherfuckas come back from worse. We adjust.`,
  ...
  NIL_FAILED_OPPONENT: [
    `Their nil just broke. That's 100 coming off their score. Damn shame, motherfucka.`,
    `You love to see it. They tried nil and it didn't hold. Sheeeeit.`,
    `Their nil is done. That's a 200-point swing in our favor. We EATING, motherfucka.`,
  ],

  NIL_SUCCEEDED_HUMAN: [
    `That nil HELD. 100 points just like that. Shit, that took nerve, motherfucka.`,
  ...
  NIL_SUCCEEDED_PARTNER: [
    `Partner made their nil. That's 100 free points. We rolling, motherfucka.`,
  ...
  BAG_WARNING_CRITICAL: [
    ...
    `{bags} bags, motherfucka. That penalty is RIGHT there. Every trick from here, ask yourself — do we NEED this?`,
    `This is not a drill. {bags} bags. One more and we lose 100 points. Play to LOSE tricks we don't need.`,
  ],

  BAG_WARNING_CAUTION: [
    `{bags} bags. That penalty is getting close, motherfucka.`,
    ...
    `Those motherfuckin bags add up quiet. {bags} right now. Be intentional about what we take.`,
  ],
  ...
  OVERBID_RISK: [
    ...
    `{needed} tricks still on the board and {left} to play for. Every card matters now, motherfucka.`,
  ...
  UNDERBID_WARNING: [
    `We already made our bid. Everything from here is bags. Play to lose, motherfucka.`,
  ...
  BIG_SPADE_PLAYED: [
    ...
    `There goes the {card}. One less big spade to worry about, motherfucka.`,
  ...
  OPPONENT_VOID: [
    `They just showed a void in {suit}. They can't follow that suit anymore — they'll be cutting, motherfucka.`,
  ...
  PARTNER_VOID: [
    ...
    `Your partner showed a void. That's not a problem — that's an opportunity, motherfucka.`,
  ...
  ROUND_END_AHEAD: [
    `{ourScore} to {theirScore}. We in front, motherfucka. Keep that same energy.`,
  ...
  ROUND_END_BEHIND: [
    `{ourScore} to {theirScore}. We down but this game ain't over, motherfucka.`,
  ...
  ROUND_END_CLOSE: [
    ...
    `Neck and neck. This is where the real motherfuckin Spades players show up.`,
  ...
  GAME_OVER_WIN: [
    `That's game, motherfucka. You BEEN ready for this — you just didn't know it yet.`,
    ...
    `We got it. And you earned every damn point. Run it back whenever you ready, motherfucka.`,
  ...
  GAME_OVER_LOSS: [
    ...
    `That one got away from us. But you're better now than when we started. That ain't nothing, motherfucka.`,
    ...
    `Game didn't go our way. But I watched you get better trick by trick. Deal that shit again, motherfucka.`,
  ],

  GAME_OVER_BLOWOUT_WIN: [
    `We didn't just win. We made a damn STATEMENT. That's dominance right there, motherfucka.`,
  ...
  GAME_OVER_BLOWOUT_LOSS: [
    ...
    `That was rough. No damn way around it. But you stayed at the table. That says something, motherfucka.`,
  ...
  WISDOM: [
    `Spades is a partnership game. You ain't out here solo, motherfucka. Everything you do affects your partner.`,
    ...
    `Counting cards ain't cheating, motherfucka. It's paying attention. There's 13 of every suit. Track 'em.`,
    `Every card somebody plays tells you something. The question is — are you listening?`,
    `Your partner is not your opponent. I've seen more games lost by motherfuckas fighting each other than by the other side.`,
    ...
    `The cards don't care about your feelings, motherfucka. They fall how they fall. Your job is to respond, not react.`,
  ],
  ...
  GOOD_PLAY: [
    `I see you, motherfucka. That was the right play.`,
    ...
    `That play right there? That's growth, motherfucka. You wouldn't have done that three rounds ago.`,
  ...
  BAD_PLAY: [
    ...
    `That card had a job and that wasn't it, motherfucka.`,
  ...
  ENCOURAGEMENT: [
    `Rough stretch. That's part of it, motherfucka. Stay in the game.`,
    ...
    `You still here. You still playing. That's more than most motherfuckas do when it gets hard.`,
  ],
  ...
  TRASH_TALK_WINNING: [
    ...
    `They played that like they WANTED us to win. Shit, we'll take it, motherfucka.`,
    ...
    `I've seen motherfuckas play bad before but this... sheeeeit. This is something else.`,
  ...
  TRASH_TALK_NIL_BUSTED: [
    ...
    `We hunted that nil down. You thought you could sneak your ass through? Not at THIS table, motherfucka.`,
    `That nil was doomed from the damn start. We just confirmed it.`,
  ],

  TRASH_TALK_COMEBACK: [
    `They was talking all that shit when they was ahead. Where's that energy NOW, motherfucka?`,
  ...
  TRASH_TALK_GENERAL: [
    `I've been playing Spades longer than these motherfuckas been alive. They don't want this shit.`,
    ...
    `This the kind of game where afterwards they gonna say 'the cards were bad.' Bitch, the cards were fine.`,
  ...
  HYPE_TOOK_TRICK: [
    `BRING that to me. Bring that RIGHT here, motherfucka. That's OURS.`,
    ...
    `WHERE is the competition? I was told there would be competition at this motherfuckin table!`,
